...
(function (global, factory) {
  ...
  var Collapse = /*#__PURE__*/function () {
    function Collapse(element, config) {
      ...
      this._triggerArray = makeArray(SelectorEngine.find(SELECTOR_DATA_TOGGLE + "[href=\"#" + element.id + "\"]," + (SELECTOR_DATA_TOGGLE + "[data-target=\"#" + element.id + "\"]")));
      var toggleList = makeArray(SelectorEngine.find(SELECTOR_DATA_TOGGLE));
